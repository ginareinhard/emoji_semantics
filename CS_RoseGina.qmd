...
The findings do not provide evidence for @fricke2024semantic's experimental hypothesis, which was based on the pictorial approach. Instead, as the authors note, the results suggest that visually similar emojis can convey different meanings, even when they correspond to the same human facial expressions. However, Fricke, Grosz & Scheffler [-@fricke2024semantic: 12] point out that while this strongly aligns with the predictions of the lexicalist approach, it does not automatically provide clear evidence for it.
