...
Before we start analysing, we should translate the categories labels (levels) into English. Using a combination of `mutate()` and `recode()`, we translate *männlich* to *men*, *weiblich* to *women*, and *divers* to *non-binary.*[^1]
