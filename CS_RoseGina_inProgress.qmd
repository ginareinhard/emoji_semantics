...
<!-- @fricke2024semantic asked whether AU+ emoji pairs and AU- emoji pairs are treated any differently depending on the context in which they are assigned. **(\@RoseGina, which two types? So far the types referred to pairs of emojis, not single emojis. Please clarify. Also you seem to repeat the research aim at the end of the next section. Is that intended? I personally find the explanation below much clearer.)** #ganzen Absatz löschen?-->
