...
1.  **"Only in the 😐😑 pair does the matching rate for one emoji exceed chance level, while the matching rate for the other falls below chance." (marked as correct) --\>**

2.  **"The disparate matching rates of the 😐😑 pair indicate that, in general, AU differences affect participants' preferences." (marked as incorrect) --\> Am I right to think that this depends whether the statement refers to AU difference in general, across all emoji pairs, or in this specific pair? If so, you need to specify which you mean.**
