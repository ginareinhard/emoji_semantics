...
The answer is no, seemingly not. AU-difference does not seem to be critical to the choice of an emoji in a context. In the plot, the matching emoji was "generally preferred with matching rates above chance level" in the AU+ and the AU- condition (exception: mild irritation). 

However, we also see that minor visual differences between emojis do affect the understanding and choice of emojis in different contexts: By slightly varying the contexts, participants were made to choose emojis with different facial features/expressions. Interestingly, matching rates were quite similar within emoji pairs (except for mild irritation-annoyance), especially: happiness - (cheeky) laughter and happiness2 - bashfulness -> meaning?
