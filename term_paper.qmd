...
data_no_filler <- data |> #remove fillr rows
  filter(match2 != "filler")

ggplot(data_no_filler, mapping = aes(x = match2)) +
  geom_bar()
...
#the plot does not really look meaningful, i.e. there is not a real difference.
