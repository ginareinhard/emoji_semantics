...
This chapter will walk you through: <!-- Vorschläge -->
...
We will work with data of the study by @fricke2024semantic. @fricke2024semantic have made their data and their analysis code available to the public. You can access it at <https://osf.io/k2t9p/>. The data is contained in the file `raw_data.csv`.
