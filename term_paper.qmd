...
The easiest way is to use the emoji keyboard (on Mac with the Shortcut fn+e). The emoji keyboard is also available in RStudio (Edit -\> Emojis & Symbols). Alternatively, there are emoji libraries, for example "emo(ji)" developed by @wickham2024emoji.
