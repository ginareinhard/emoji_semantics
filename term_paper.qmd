...
2\) Looking at the final patchwork, which "sub-plot" stands out from the rest?
...
<br><br> 3) Which interpretation of this finding is most accurate?
...
By looking and interpreting the above plot, we can now finally answer the research question: Do AU-differences lead to differences in meaning between the two emojis of a pair?

The answer is no, seemingly not. AU-difference does not seem to be critical to the choice of an emoji in a context. In the plot, the matching emoji was "generally preferred with matching rates above chance level" [@fricke2024semantic] in the AU+ and the AU- condition. 
...
The emoji pair *mild irritation* 😐 - *annoyance* 😑 sets itself apart from the rest: There is a considerable difference between the matching rates. Perhaps counterintuitively, this means that participants opted for the same emoji in both contexts.

Apparently, two thirds (66.67 %) of participants favoured the non matching emoji in the *mild irritation*-context: they chose 😑 in the context "is slightly irritated". One of the single-sentence-narratives in this context was "a malfunctioning wifi router". Which emoji would you choose in this context, 😐 or 😑? 

::: callout-tip
#### Quiz time! {.unnumbered}

4\)  Which of the following explanations reasons could have caused this variance? Select all options that apply.

```{r echo=FALSE, results="asis"}

check_question(c("Participants perceived the stories of the context `slightly irritated´ as more annoying than was expected.", "The stories created for being slightly irritated and being annoyed were too similar to each other."), options = c("Participants perceived the stories of the context `slightly irritated´ as more annoying than was expected.", "The stories created for being slightly irritated and being annoyed were too similar to each other.", "option c", "option d", "option e"), type = "checkbox",
random_answer_order = TRUE,
button_label = "Check answer",
...
<br><br> 5) How can a small difference (such as < 2%) between matching rates within pairs be interpreted?

```{r echo=FALSE, results="asis"}
check_question("Within these pairs, the same amount of participants choose the matching emoji.", options = c("Within these pairs, the same amount of participants choose the matching emoji.", "option a", "option b", "option c"), type = "radio", 
random_answer_order = TRUE,
button_label = "Check answer",
