...
@fricke2024semantic differentiate two approaches to emoji semantics:
The pictorial approach of @maier2023emojis considers emojis to be depictions of the writer´s face in the moment of typing. The correpondence of features of emojis and human faces is central for this approach. In contrast, the lexicalist approach emphasises the meanings of emojis as described by words. It predicts that whether visual (AU) differences correspond to facial characteristics or not does not matter: For both types of pairs, the context-matching emoji should be chosen more often than the non-matching one.

Following the pictorial approach, @fricke2024semantic predict that participants will choose the context-matching emoji more often in the \[AU+\] condition than in the \[AU-\] condition. For the \[AU-\] pairs, the choice pattern is predicted to be more randomly distributed.
