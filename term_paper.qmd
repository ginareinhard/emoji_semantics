...
That looks a little chaotic... Right, we have to order the levels again.
...
Already much better! If we do not want the bars to be stacked on top of each other, we can change that by adding the argument position = "dodge" to the geom_bar function.
