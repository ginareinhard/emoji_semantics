...
Four single-sentence narratives were created for each of the contexts. For an example, see @fig-testitems, translated below [taken from @fricke2024semantic, p.6]:
