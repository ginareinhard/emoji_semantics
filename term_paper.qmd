...
#### Click here for the solution to the Task
...
```{r echo=FALSE, results="asis"}
check_question(c("The emoji 😐 was chosen significantly less for its matching context than all the other emojis.", "Only in the 😐😑 pair, the matching rate for one emoji is above chance and for the other below chance."), options = c("The emoji 😐 was chosen significantly less for its matching context than all the other emojis.", "There is a major difference between matching rates of the contexts annoyance and happiness.","Only in the 😐😑 pair, the matching rate for one emoji is above chance and for the other below chance.", "Since matching rates differ a lot in the 😐😑 plot, AU-difference seems to affect participants' preference."), type = "checkbox", 
random_answer_order = TRUE,
button_label = "Check answer",
