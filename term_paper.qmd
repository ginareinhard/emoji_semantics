...
Now, we fill in the names of the plots and choose some meaningful names. If you have not already installed the patchwork package and/or have not loaded the library, please do so now by `install.packages(patchwork)` and `library(patchwork)`.
