...
3.  Display the plot as a barplot. By default, `geom_bar` counts how many times *match* and *no match* occur. However, as we have already calculated and stored the values in the column `percent`, we use `geom_col` to use the data as is.
...
Now, we fill in the names of the plots and choose some meaningful names:
...
-   In "Introducing the study":
    ...
    -   text of "Deconstructing emojis into Action Units" and "The experiment"
