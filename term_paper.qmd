...
1\) What problems are likely to occur if you plot emoji understanding by gender in a barplot with unequal group sizes?

```{r echo=FALSE, results="asis"}

check_question("It may appear as if men have a greater emoji understanding simply because of their group size.", options = c("It may appear as if men have a greater emoji understanding simply because of their group size.", "The differences in emoji understanding between gender groups may look smaller than they actually are.", "The differences in emoji understanding within gender groups may look bigger than they actually are.", "The bars for the non-binary group may appear huge.", "There will be no problems if we use ggplot."), type = "radio", 
random_answer_order = TRUE,
button_label = "Check answer",
right = "That´s right! Unequal group sizes can exaggerate differences in understanding by showing larger totals for bigger groups. <br><br>Can you think of ways to ensure that these factors are controlled for? / How could you address these issues?",
...
2\) Looking at the final patchwork, which "sub-plot" shows the most significant finding?
...
```
<br><br>
3\) Which interpretation of this finding is most accurate?
...
"each emoji is preferred over a visually similar emoji in a context that represents a prominent aspect of its meaning, as determined on the basis of the emoji’s Emojipedia.org entry and a norming experiment. Thus, subtle differences in emojis that otherwise look alike lead to differences in meaning." exception is the pair mild disappointment - moderate disappointment
