...
### Translate factor levels from German to English

As you will see, the gender groups and the degrees of emoji understanding in the data set are in German. Let's translate them into English before we start our analysis and create our visualisation.

The relevant variables are called 'gender' and 'emoji_understanding'. We first need to convert them as factors so that we can look at the levels:
...
The uneven gender distribution is likely to skew our visualisation. To solve this problem, we will, like @fricke2024semantic, use relative rather than absolute frequencies and exclude the very small group of three non-binary participants.
