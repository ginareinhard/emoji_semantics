...
# 
# young$emoji_understanding <- recode(young$emoji_understanding, "mittelmäßig" = "moderate", 
...
emoji_understanding_gender <- data |>
  ...
  mutate(emoji_understanding = factor(emoji_understanding, levels = c("mittelmäßig", "eher gut", "gut", "sehr gut")))
