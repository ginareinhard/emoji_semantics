...
ggplot(aes(x = context, y = percent, fill = match)) +
geom_bar(stat = "identity") +
scale_x_discrete(limits = c("happiness", "(cheeky) laughter"), guide = guide_axis(n.dodge = 2)) +
geom_text(aes(label = percent), position = position_stack(vjust = 0.5)) +
labs(x = "", y = "", title = "😃 😆")+
theme_minimal() +
theme(plot.title = element_text(hjust = 0.5))
...
ggplot(aes(x = context, y = percent, fill = match)) +
geom_bar(stat = "identity") +
scale_x_discrete(limits = c("mild irritation", "annoyance"), guide = guide_axis(n.dodge = 2)) +
geom_text(aes(label = percent), position = position_stack(vjust = 0.5)) +
labs(x = "", y = "", title = "😐 😑") +
theme_minimal() +
theme(plot.title = element_text(hjust = 0.5))
...
ggplot(aes(x = context, y = percent, fill = match)) +
geom_bar(stat = "identity") +
scale_x_discrete(limits = c("mild disappointment", "moderate disappointment"), guide = guide_axis(n.dodge = 2)) +
geom_text(aes(label = percent), position = position_stack(vjust = 0.5)) +
labs(x = "", y = "", title = "🙁️ ☹️")+
theme_minimal() +
theme(plot.title = element_text(hjust = 0.5))
...
ggplot(aes(x = context, y = percent, fill = match)) +
geom_bar(stat = "identity") +
scale_x_discrete(limits = c("amusement", "(intense) happiness"), guide = guide_axis(n.dodge = 2)) +
geom_text(aes(label = percent), position = position_stack(vjust = 0.5)) +
labs(x = "", y = "", title = "😄 😁") +
theme_minimal() +
theme(plot.title = element_text(hjust = 0.5))
...
ggplot(aes(x = context, y = percent, fill = match)) +
geom_bar(stat = "identity") +
scale_x_discrete(limits = c("happiness2", "bashfulness"), guide = guide_axis(n.dodge = 2)) +
geom_text(aes(label = percent), position = position_stack(vjust = 0.5)) +
labs(x = "", y = "", title = "😊 ☺️") + 
theme_minimal() +
theme(plot.title = element_text(hjust = 0.5))
...
AU_plus_2 <- annotate_figure(AU_plus_2,
...
AU_minus_2 <- annotate_figure(AU_minus_2,
top = text_grob("[AU-] condition"))
