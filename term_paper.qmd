...
You are now a pro in handling barplots! You can build, customise, arrange, and interpret them. Barplots are powerful for visualising categorical data, offering a straightforward way to compare frequencies and make patterns apparent. However, like any data visualisation method, they do have their limitations. For instance, they are not ideal for displaying continuous data. Building plots and assembling them can be quite fiddly. It can take some trial-and-error to make the final plot look like what you have imagined. But there is a solution for (almost) anything and hopefully, the beautiful plot you create in the process will be worth the effort.

Our analysis revealed interesting gender-specific insights into emoji understanding. Women were more likely to report understanding emojis *very well* compared to men. Men, on the other hand, showed a more even distribution across all levels of understanding, suggesting a wider range of self-assessments. However, both genders stated that they understood emoji well overall. Our visualisations have been adjusted for gender imbalance, demonstrating the importance of taking sample size differences into account. The small sample size of non-binary participants limited further analysis and emphasises the need for more inclusive data in further studies.
