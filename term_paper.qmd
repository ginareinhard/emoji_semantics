...
-   analysing and interpreting frequencies of two categorical variables (gender and emoji understanding)
-   visualising frequencies using a barplot
-   inserting and displaying emojis in R and inside of plots
-   creating and interpreting a complex plot
...
In a new data frame `AU_plot`, we store all and only the columns needed to build our plot:
