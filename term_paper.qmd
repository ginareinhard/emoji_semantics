...
Task: participants must choose between emojis of a pair (Forced chocie task), help "Alex/Anna" help using the emoji that best matches the text (6)
:::
...
#this was outside of a code chunk, I´m not sure where to put it
