...
![Image from @fricke2024semantic](images/emoji_use.png){#fig-emojiuse fig-align="center" width="550"}

![Image from @fricke2024semantic](images/emoji_attitude.png){#fig-emojiattitude fig-align="center" width="550"}
...
![Figure X: The gender_understanding_count object as visualised using the `View()` function in RStudio](images/gender_understanding_count.png){fig-align="center" width="400"}
...
We use `ggplot()` to create a bar chart in which emoji understanding is arranged in ascending order on the x-axis and the relative frequencies on the y-axis. The bars are coloured according to gender:
