...
To target their research question **Do AU differences lead to differences in meaning between the two emojis of a pair?**, @fricke2024semantic made predictions in line with the pictorial approach by @maier2023emojis: They expected that visual differences between emojis which correspond to human facial features (AU+) would be more semantically relevant compared to those that do not (AU-).
