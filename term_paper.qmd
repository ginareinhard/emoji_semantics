...
### Question for Elen 3/6: Would it be better to use geom_col instead of geom_bar(stat = "identity"), since the two are seemingly identical? Or is unnecessarily more complicated for the textbook readers?

### Question for Elen 4/6: Is it too advanced to define a function to create the plot? Instead, we could write out the code as above under "Delete" but a lot of it would be redundant.
